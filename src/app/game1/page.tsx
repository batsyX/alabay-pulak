      ...
      <div className='container ' ref={scrollRef}>
        ...
        <motion.div initial={{x:-1000}} animate={{x:0}} transition={{duration:0.5}} 
         className="h-[100vh] w-full  boxes bg-opacity-20 max-md:overflow-hidden max-md:pl-2">
          <div className='flex flex-col justify-center pt-10 md:pl-20 w-[800px] max-md:w-full'>
            <h1 className='text-8xl text-white font-baronKuffner max-md:text-6xl'>ALABAY GUARDIAN </h1>
            <h2 className='text-6xl text-[#A4A8FF] font-bebasNeue pb-8 max-md:text-4xl'>SHEPHERD OF THE STEPPES</h2>
            ...
            <button className='flex gap-3 bg-[#A4A8FF] w-[200px] rounded-3xl h-[60px] justify-around items-center cursor-pointer z-50'>
          ...
          <h3 className='text-2xl text-[#A4A8FF] font-montserrat font-extrabold md:pl-20 pt-6'>GAME <span className='text-white'>PREVIEW</span></h3>
        ...
        className="h-[100vh] w-full  boxes bg-opacity-20 max-md:pl-2">
          <div className='flex flex-col justify-center pt-10 pl-20 w-[800px] max-md:w-full max-md:pl-0'>
            <h1 className='text-8xl text-white font-baronKuffner max-md:text-6xl'>ALABAY GUARDIAN </h1>
            <h2 className='text-6xl text-[#A4A8FF] font-bebasNeue pb-5 max-md:text-4xl'>SHEPHERD OF THE STEPPES</h2>
            <p className='text-2xl text-[#A4A8FF] font-montserrat '>FEATURES</p>
          </div>

          <div className='w-3/5 max-md:w-full md:pl-20 pt-4 pb-5 text-white font-montserrat text-xlg font-bold max-md:pr-12 '>
            Explore a variety of landscapes, including <span className='text-purple-300'>mountains, forests, deserts,</span> and ancient ruins. 
            <p className='pt-3'>
            Use the Alabay's <span className='text-purple-300'>abilities</span> to solve <span className='text-purple-300'>puzzles</span> that involve moving objects, activating mechanisms, or finding hidden clues. </p>
            <p className='pt-3'>
            ...
            Challenge Modes:
              <br /><span className='text-purplepurple-300'>- Time Trials:</span> Compete in special timed challenges where the Alabai must navigate through complex mazes or
                  complete puzzles within a time limit.
              <br /><span className='text-purple-300'>  - Exploration Mastery:</span> 
